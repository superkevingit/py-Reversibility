...
opts['lr_update'] = 0.0002 # 0.0003 in MATLAB code / 0.0002 in python code
...
opts['GAN_lr_update'] = 0.0015

opts['lr_bias_mult'] = {'bias': 2}

opts['time_r_interval'] = 8
opts['time_r_threshold'] = 0.85
